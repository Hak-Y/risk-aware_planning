...
class VoxelResBackBone8xVoxelNeXt(nn.Module):
    def __init__(self, input_channels, **kwargs):
        ...
        self.conv_input = spconv.SparseSequential(
            spconv.SubMConv3d(input_channels, channels[0], 3, padding=1, bias=False, algo=spconv.ConvAlgo.Native, indice_key='subm1').to(device),
            norm_fn(channels[0]).to(device),
            nn.ReLU(),
        )
        ...
        self.conv_out = spconv.SparseSequential(
            ...
            spconv.SparseConv2d(channels[3], out_channel, 3, stride=2, padding=0, bias=False, indice_key='spconv_down2'),
            norm_fn(out_channel),
            nn.ReLU(),
        )
    ...
    def forward(self, batch_dict):
        ...
        sparse_shape = batch_dict['sparse_shape']
        ...
        # return batch_dict
        return batch_dict['encoded_spconv_tensor']