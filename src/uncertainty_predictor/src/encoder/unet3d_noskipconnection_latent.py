...
class Encoder(nn.Module):
    ...
    def get_memory_usage(self):
        ...
        free_memory_bytes = reserved_memory_bytes - allocated_memory_bytes
        ...
        print(f"Free GPU Memory (inside reserved): {free_memory_gb:.2f} GB")
...
class UNet3D_noskipconnection_latent(Abstract3DUNet):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid=True, f_maps=64, layer_order='gcr',
        ...
        super(UNet3D_noskipconnection_latent, self).__init__(in_channels=in_channels, out_channels=out_channels, final_sigmoid=final_sigmoid,
