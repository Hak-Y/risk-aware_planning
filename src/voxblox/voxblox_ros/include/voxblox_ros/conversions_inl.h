...
void serializeLayerAsMsg(const Layer<VoxelType>& layer, const bool only_updated,
  ...
  // std:: cout << "serializeLayerAsMsg" <<msg->layer_type <<  "try" << std::endl;
  CHECK_NOTNULL(msg);
  ...
  // std:: cout << "serializeLayerAsMsg" <<msg->layer_type <<  "done" << std::endl;
}  // namespace voxblox
...
bool deserializeMsgToLayer(const voxblox_msgs::Layer& msg,
                           ...
                           Layer<VoxelType>* layer) {
  CHECK_NOTNULL(layer);
  //  std:: cout << "deserializeMsgToLayer" <<msg.layer_type <<  "try" << std::endl;
  ...
  // std:: cout << "deserializeMsgToLayer" <<msg.layer_type <<  "done" << std::endl;
  return true;
}
