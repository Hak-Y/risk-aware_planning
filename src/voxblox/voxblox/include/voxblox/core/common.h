...
inline IndexType getGridIndexFromPoint(const Point& point,
  ...
  // if(grid_size_inv==0.625){                                                                              
    // std::cout << "my grid size inv: " << grid_size_inv << std::endl;
    // std::cout << "my indx1: " << point.x() << point.y() << point.z() << std::endl;
    // std::cout << "my indx2: " << std::floor(point.x() * grid_size_inv + kEpsilon) << std::floor(point.x() * grid_size_inv + kEpsilon) << std::floor(point.x() * grid_size_inv + kEpsilon) << std::endl;
  // }
