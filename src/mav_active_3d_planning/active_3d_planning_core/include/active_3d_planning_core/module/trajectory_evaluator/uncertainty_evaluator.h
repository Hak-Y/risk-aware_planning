#ifndef ACTIVE_3D_PLANNING_CORE_MODULE_TRAJECTORY_EVALUATOR_UNCERTAINTY_EVALUATOR_H_
#define ACTIVE_3D_PLANNING_CORE_MODULE_TRAJECTORY_EVALUATOR_UNCERTAINTY_EVALUATOR_H_
...
class UncertaintyEvaluator : public SimulatedSensorEvaluator {
 public:
  explicit UncertaintyEvaluator(PlannerI& planner);  // NOLINT

  void setupFromParamMap(Module::ParamMap* param_map) override;

 protected:
  static ModuleFactoryRegistry::Registration<UncertaintyEvaluator> registration;

  // members
    // members
  std::unique_ptr<BoundingVolume> outer_volume_;
  map::UNCERTAINTYMap* map_;
...
#endif  // ACTIVE_3D_PLANNING_CORE_MODULE_TRAJECTORY_EVALUATOR_UNCERTAINTY_EVALUATOR_H_
