...
class OnlinePlanner : public PlannerI, public ModuleBase {
 public:
  ...
  bool isReturnPlanningMode() {return return_planning_;}
 ...
 protected:
  ...
  bool return_planning_;
  // bool return_planning_;              // whether to plan return to base (exploratoin finish or low batttery?)
