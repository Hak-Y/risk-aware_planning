...
OnlinePlanner::OnlinePlanner(ModuleFactory* factory,
    ...
    : factory_(factory), running_(false), planning_(false),return_planning_(false) {
  // Setup params
...
void OnlinePlanner::setupFromParamMap(Module::ParamMap* param_map) {
  ...
  setParam<bool>(param_map, "log_performance", &p_log_performance_, true);
